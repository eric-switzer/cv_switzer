\newcommand{\lastupdated}{May 8, 2019}
...
Past and present research areas: instrumentation and data analysis for cosmic microwave background (CMB) experiments, cosmological helium recombination and reionization, mapping
diffuse 21 cm emission at $z\sim 1$. Dissertation adviser: Lyman Page.  Title: {\it Small-scale anisotropies of the cosmic microwave background: Experimental and theoretical perspectives}.\\
}
...
% Distinguished performance 2018
% Distinguished performance 2017
% Distinguished performance 2016
% Distinguished performance 2015
% Exceeds performance 2014 (started work)
\newcommand{\honors}[1]{
\begin{resitem}
\item \reshead{Honors and awards}
\item Special Act - TEAM: GSFC CMB Study Group
\item APS, 32 most influential papers in General Relativity: ACT detection of lensing of the CMB.
...
\item 2011-     Lead: Green Bank Telescope $21$\,cm Intensity Mapping, analysis
\item 2011-     Atacama Cosmology Telescope (ACTPol)
\item 2008-2011 South Pole Telescope (SPT, Temperature)
\item 2005-2011 Atacama Cosmology Telescope (ACT, Temperature)
\end{resitem}
}
...
~\\ \reshead{Advising}\\~\\
\begin{tabular}{l p{12cm}} %\multicolumn{2}{l}
Spring 2019- & UMD Graduate Student, EXCLAIM project (Co-advisors: A. Bolatto, E. Barrentine): Carrie Volpert \\
...
% 1.1 FTE and 35k
Sept. 2018 (1 yr), PI & GSFC Internal R\&D (IRAD), {\em Microwave multiplexing} \\
% 1 M$/yr
...
Oct. 2017 (1 yr), Co-I & GSFC Internal R\&D (IRAD), {\em Balloon concept demonstrator (BOBCAT)} (PI: Alan Kogut) \\
% 800k/yr
...
% 500k/yr, 3yr
Oct. 2015 (3 yr), Co-I & NASA Archives Review, {\em Legacy Archive for Microwave Background Data Analysis (LAMBDA)} (PI: Smale, HEASARC)\\
% 68k
...
%------------------------------------------------------------------------------
% Whitepapers
% Endorsed CMB S4, PICO
% Author of IM
% Author/endorser of spectral distortion
\newcommand{\PIPERRX}{{\bf E.\ R.\ Switzer}, PIPER Collaboration, ``Sub-kelvin cooling for two kilopixel bolometer arrays in the PIPER receiver", {\em Submitted to Rev. Sci. Inst} (2019).}

\newcommand{\OdegardCIB}{N.\ Odegard, J.\ L.\ Weiland, D.\ J.\ Fixsen, D.\ T.\ Chuss, E.\ Dwek, A.\ Kogut, {\bf E.\ R.\ Switzer}, ``Determination of the Cosmic Infrared Background from COBE/FIRAS and Planck HFI Observations", {\em Accepted ApJ} (2019).}
\newcommand{\OdegardCIBhttp}[1]{\linkarticle{\OdegardCIB}{https://ui.adsabs.harvard.edu/abs/2019arXiv190411556O/abstract}{#1}}

\newcommand{\PIPERSPIES}{S.\ Pawlyk, PIPER Collaboration, ``The primordial inflation polarization explorer (PIPER): current status and performance of the first flight", {\em Proc. SPIE}~{\bf 10708} (2018).}
\newcommand{\PIPERSPIEShttp}[1]{\linkarticle{\PIPERSPIES}{http://adsabs.harvard.edu/abs/2018SPIE10708E..06P}{#1}}


\newcommand{\IMPlanck}{S.\ Yang, A.\ R.\ Pullen, {\bf E.\ R.\ Switzer}, ``Evidence for CII diffuse line emission at redshift $z\sim2.6$", {\em submitted MNRASL} (2019).}
...
Polarization Properties", {\em MNRAS}~{\bf 11/18} (2018).}
\newcommand{\ACTpolptsrchttp}[1]{\linkarticle{\ACTpolptsrc}{https://academic.oup.com/mnras/advance-article/doi/10.1093/mnras/sty2934/5154934}{#1}}
...
%------------------------------------------------------------------------------
\newcommand{\DecadalIM}{E.\ D.\ Kovetz, P.\ C.\ Breysse, A.\ Lidz, J.\ Bock, C.\ M.\ Bradford, T.-C.\ Chang, S.\ Foreman, H.\ Padmanabhan, A.\ Pullen, D.\ Riechers, M.\ B.\ Silva, {\bf E.\ R.\ Switzer}, ``Astrophysics and Cosmology with Line-Intensity Mapping," {\em Contribution to the 2020 Decadal Survey}, March 2019.}

\newcommand{\CITAEXCLAIM}{``EXCLAIM: a new balloon mission to map the cosmological history of galaxies," {\em Seminar}, Canadian Institute for Theoretical Astrophysics, University of Toronto, May 2019.} % May 9

\newcommand{\CCAIMEXCLAIM}{``The Experiment for Cryogenic Large-Aperture Intensity Mapping (EXCLAIM)," {\em Intensity Mapping Workshop}, Center for Computational Astrophysics, Simons Institute, February 2019.} % Feb 21

\newcommand{\IHPIM}{``Challenges in Analysis of Intensity Mapping Data," {\em Analytics, Inference, and Computation in Cosmology}, Institut Henri Poincar\'e, Paris, October 2018.} % Oct 25

\newcommand{\CataldoIAC}{Giuseppe Cataldo et al., ``Second-generation Micro-Spec: a compact spectrometer for far-infrared and submillimeter space missions," {\em Proc. IAC}(69th congress), 2018.} % Oct 2018

\newcommand{\AspenIM}{``Interpreting intensity mapping data in the presence of foregrounds," {\em Cosmological Signals from Cosmic Dawn to the Present}, Aspen, February 2018.} % Feb 5
...
\newcommand{\RRIPIXIE}{``The Primordial Inflation Explorer (PIXIE),"
{\em CMB spectral distortions from cosmic baryon evolution}, Raman Research Institute, July
2016.} % July 13

\newcommand{\RRIIMFG}{``Global foregrounds and intensity mapping,"
{\em CMB spectral distortions from cosmic baryon evolution}, Raman Research Institute, July
2016.} % July 13
...
\newcommand{\SEDPIPER}{``Measuring mm/sub-mm curls and circles across the sky
with the Primordial Inflation Polarization Explorer (PIPER)," {\em Science and
Exploration Directorate Director's Seminar (GSFC)}, Nov. 2013.} % Nov 8
