\newcommand{\lastupdated}{September 22, 2020}
...
\item 2015 NASA Special Act Award: LAMBDA contributions to HEASARC Senior Review
% ACT$ CMB lensing
...
Summer 2020 & NASA interns (EXCLAIM): Ethan Bennett, Chace Cho (E. Barrentine joint), Joaquin Matticoli, Florian Roselli (G. Cataldo primary), Jared Termini (E. Barrentine, T. Essinger-Hileman primary) \\
...
%------------------------------------------------------------------------------
\newcommand{\PIPERwindows}{R.\ Datta, PIPER collaboration, ``Anti-reflection-coated vacuum window for the PIPER balloon-borne instrument" {\em RSI submitted} (Sept. 2020).}
...
\newcommand{\SPTptsrcfinal}{W.\ Everett, SPT collaboration ``Millimeter-wave Point Sources from the 2500-square-degree SPT-SZ Survey: Catalog and Population Statistics" {\em ApJ}(1) (Sept. 2020).}
