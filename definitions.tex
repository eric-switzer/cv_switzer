\newcommand{\lastupdated}{Dec. 7, 2021}
...
for next-generation missions. Dr. Switzer is PI of the EXCLAIM mission and was
deputy PI of PIPER.  Before starting at NASA, he led the analysis of 21 cm
intensity mapping data acquired with the Green Bank Telescope, worked to
develop and commission the Atacama Cosmology Telescope, and developed an
accurate theory of cosmological helium recombination.\\
...
Detectors" {\em Submitted JLTP} (Nov. 2020).}
\newcommand{\KIDoptimumhttp}[1]{\linkarticle{\KIDoptimum}{}{#1}}
