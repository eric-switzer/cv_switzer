\newcommand{\lastupdated}{August 30, 2019}
...
%distortion
\newcommand{\LitebirdLTD}{LiteBIRD collaboration, Hajime Sugai lead ``Updated
design of the CMB polarization experiment satellite LiteBIRD" Submitted JLTD
(2019).}

\newcommand{\EXCLAIMoverview}{EXCLAIM Collaboration, {\bf E.\ R.\ Switzer}
lead, ``The Experiment for Cryogenic Large-aperture Intensity Mapping
(EXCLAIM)," Submitted JLTD (2019).}
...
SPTpol Survey," Submitted MNRAS (2019).}
\newcommand{\SPTPolptsrchttp}[1]{\linkarticle{\SPTPolptsrc}{http://adsabs.harvard.edu/abs/2019arXiv190702156G}{#1}}
...
spectrometer for far-infrared and submillimeter space missions," IAC-18-A7.3.8
(2019).}

\newcommand{\PIPERRX}{{\bf E.\ R.\ Switzer}, PIPER Collaboration, ``Sub-kelvin
cooling for two kilopixel bolometer arrays in the PIPER receiver," {\em Accepted Rev. Sci. Inst, Editor's pick/SciLight} (2019).}
...
\newcommand{\Decadal}{Co-signer or contributor to 15 Decadal White Papers (2019).}
