\newcommand{\lastupdated}{Feb. 29, 2020}
...
Jan. 2020 & Service: 4 letters of reference \\
...
~\\ \reshead{Advising}\\~\\
\begin{tabular}{l p{12cm}} %\multicolumn{2}{l}
Spring 2020- & NASA intern: Lee Roger Chevres Fernandez, Konrad Shire \\
2019-2020 & NASA/UMD intern (gap year): Jonas Mugge-Durum \\
Summer 2019 & NASA interns: Alex Lamb, Henry Grant \\
...
design of the CMB polarization experiment satellite LiteBIRD" {\em JLTP} (Jan. 2020).}
...
cooling for two kilopixel bolometer arrays in the PIPER receiver," {\em Rev. Sci. Inst.}~{\bf 90}(9), Editor's pick/SciLight, cover (2019).}
...
% Talks
\newcommand{\GSFCAPRA}{``EXCLAIM and the APRA program" {\em PI Workshop}, NASA GSFC, February 2020.} % Feb 28

\newcommand{\HQEXCLAIMone}{``The Experiment for Cryogenic Large-Aperture Intensity Mapping (EXCLAIM)," {\em PI Workshop, in absentia by Emily Barrentine}, NASA HQ, October 2019.} % Oct 7
